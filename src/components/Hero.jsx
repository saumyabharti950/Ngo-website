...
function Hero() {
  ...
  return <section id="home" className="hero" ref={heroRef}>
    ...
    <div className="container hero-container"><div className="hero-content">
      ...
      <p className="hero-tagline hero-reveal hero-reveal-up">HEALTH <b>|</b> LEARN <b>|</b> SKILL <b>|</b> EARN</p>
      <p className="hero-description hero-reveal hero-reveal-up">Social Initiative for India Foundation works with communities and institutions to create inclusive, evidence-based and sustainable development solutions.</p>
